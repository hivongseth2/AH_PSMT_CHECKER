...
const OLPromotionResults = ({
  ...
  const filteredDateResults =
    (olResults?.dateResults || [])?.filter((dateResult) => {
  ...
  return (
    <>
      {olResults?.message ? (
        <div className="text-gray-700 mb-4 p-4 bg-blue-50 rounded-lg">{olResults.message}</div>
      ) : null}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          <Card className="bg-white border-l-4 border-blue-500">
            <CardContent className="p-4">
              ...
              <h4 className="text-2xl font-bold text-gray-800">
                {Object.keys(olChecklistStats.customerStats).length}
              </h4>
            </CardContent>
          </Card>
          <Card className="bg-white border-l-4 border-green-500">
            <CardContent className="p-4">
              ...
              <h4 className="text-2xl font-bold text-gray-800">{olChecklistStats.totalStores}</h4>
            </CardContent>
          </Card>
          <Card className="bg-white border-l-4 border-purple-500">
            <CardContent className="p-4">
              ...
              <h4 className="text-2xl font-bold text-gray-800">
                {olResults.totalExpectedPromotions || 0}
              </h4>
            </CardContent>
          </Card>
          <Card className="bg-white border-l-4 border-amber-500">
            <CardContent className="p-4">
              ...
              <h4 className="text-2xl font-bold text-gray-800">
                {olResults.totalActualPromotions || 0}
              </h4>
            </CardContent>
          </Card>
        </div>
...
export default OLPromotionResults;